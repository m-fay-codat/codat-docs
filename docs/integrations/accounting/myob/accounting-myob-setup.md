...
1. Go to <a className="external" href="[https://developer.myob.com/program/become-a-myob-developer-partner/](https://developer.myob.com/become-a-myob-developer-partner/)" target="_blank">MYOB's page for developers</a>.
